...
public class PartType extends InfoType {
	...
	/** (Engine) The type of fuel this engine takes.  If set to "anyFuel" then any fuel can be used */
	public String usedFuelType = "anyFuel";
	/** (Fuel) The amount of fuel this fuel tank gives */
	public int fuel = 0;
	/** (Fuel) The type of fuel contained in this part */
	public String fuelType = "genericFuel";
	/** (Fuel) The item this part turns into when out of fuel.  ONLY WORKS WITH SINGLE-STACK FUEL ITEM */
	public String emptyItem = null;
	...
	protected void read(String[] split, TypeFile file) 
	{
		...
		try 
		{
			...
			else if(split[0].equals("EmptyFuelItem"))
				emptyItem = split[1];
			
			else if(split[0].equals("FuelType"))
				fuelType = split[1];
			else if(split[0].equals("EngineFuelType"))
				usedFuelType = split[1];
			//Recipe
