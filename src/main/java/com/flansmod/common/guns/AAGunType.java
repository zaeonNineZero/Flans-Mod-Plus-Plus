...
public class AAGunType extends InfoType
{
	...
	/** Whether particles imitating a muzzle flash should appear when firing */
	public boolean useMuzzleParticle = false;
	public String muzzleParticleType = "flame";
	...
	/** Get the muzzle particle settings.  Do not use attachments for this one */
