...
{	
	...
	public void handleClientSide(EntityPlayer clientPlayer)
	{
    	...
    	FMLClientHandler.instance().getClient().getSoundHandler().playSound(new PositionedSoundRecord(new ResourceLocation(block.stepSound.getBreakSound()), x + 0.5F, y + 0.5F, z + 0.5F, 1.0F, 1.5F));
	}
}
