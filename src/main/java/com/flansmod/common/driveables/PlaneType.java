...
public class PlaneType extends DriveableType
{
	...
	/** Airspeed limiter for capping speeds at high throttle values */
	public float maxAirspeed = 0.75F;
	...
	/** Whether losing the tail causes the plane to spin out of control */
	...
	protected void read(String[] split, TypeFile file)
	{
		...
		{		
			...
			if(split[0].equals("MaxAirspeed"))
				maxAirspeed = Float.parseFloat(split[1]);
